...
function twirledGradient(gradient_index, first_color, second_color) {
  const the_gradient =
    "pylon-gradient" + first_color + second_color + Math.floor(gradient_index);
  return the_gradient;
}

// 0-100
function wDownWest2bUpEast(
  gradient_index,
  west_y,
  east_y,
  first_color,
  ...
  const gradient_id = twirledGradient(
    gradient_index,
    first_color,
    second_color,
  );
...
// 100 - 200
function wRightSouth2bLeftNorth(
  gradient_index,
  south_x,
  north_x,
  first_color,
...
// 300 - 400
function wLeftNorth2bRightSouth(
  gradient_index,
  north_x,
  south_x,
  first_color,
...
function makeGradients(pylon_colors) {
  ...
  for (let gradient_index = 0; gradient_index < 100; gradient_index++) {
    west_y++;
    east_y = 100 - west_y;
    let west_2_east_gradient = wDownWest2bUpEast(
      gradient_index,
      west_y,
      east_y,
      first_color,
    ...
    west_2_east_gradient = wDownWest2bUpEast(
      gradient_index,
      west_y,
      east_y,
      second_color,
  ...
  for (let gradient_index = 100; gradient_index < 200; gradient_index++) {
    south_x++;
    north_x = 100 - south_x;
    let south_2_north_gradient = wRightSouth2bLeftNorth(
      gradient_index,
      south_x,
      north_x,
      first_color,
    ...
    south_2_north_gradient = wRightSouth2bLeftNorth(
      gradient_index,
      south_x,
      north_x,
      second_color,
  ...
  for (let gradient_index = 200; gradient_index < 300; gradient_index++) {
    east_y--;
    west_y = 100 - east_y;
    let east_2_west_gradient = wUpEast2bDownWest(
      gradient_index,
      east_y,
      west_y,
      first_color,
    ...
    east_2_west_gradient = wUpEast2bDownWest(
      gradient_index,
      east_y,
      west_y,
      second_color,
  ...
  for (let gradient_index = 300; gradient_index < 400; gradient_index++) {
    north_x--;
    south_x = 100 - north_x;
    let north_2_south_gradient = wLeftNorth2bRightSouth(
      gradient_index,
      north_x,
      south_x,
      first_color,
    ...
    north_2_south_gradient = wLeftNorth2bRightSouth(
      gradient_index,
      north_x,
      south_x,
      second_color,
