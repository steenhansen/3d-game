...
function filledTriangle(three_points, the_color) {
...
function drawLine2(from_to, the_color, line_width) {
...
function getTetrahedron(degrees_0_90) {
  ...
  // drawLine2( [roof_a, roof_b], black_color, 1); 
  // drawLine2( [roof_b, floor_b], black_color, 1); 
  // drawLine2( [roof_a, floor_b], black_color, 1);    
  if (degrees_0_90 > 25 || degrees_0_90 < 65) {
    filledTriangle([roof_a, roof_b, floor_b], `rgb(0, 255,0)`, "");
  }

  // drawLine2([roof_a, roof_b], black_color, 1);
  // drawLine2( [roof_b, floor_a], black_color, 1);     
  // drawLine2( [roof_a, floor_a], black_color, 1);    
  if (degrees_0_90 > 25 && degrees_0_90 < 69) {
    filledTriangle([roof_a, roof_b, floor_a], `rgb( 255,0,0)`, "");
  }

  // drawLine2( [floor_b, floor_a], red_color, 1);
  // drawLine2( [roof_a, floor_b], purple_color, 3);
  // drawLine2( [roof_a, floor_a], green_color, 1);
  if (degrees_0_90 > 42 || degrees_0_90 < 3) {
    filledTriangle([floor_a, floor_b, roof_a], `rgb( 0,0,255)`, "");
  }


  // drawLine2( [floor_a, floor_b], black_color, 1);
  // drawLine2( [floor_b, roof_b], purple_color, 2);
  // drawLine2( [floor_a, roof_b], green_color, 3);
  //  if (degrees_0_90 > -1 && degrees_0_90 < 47) {
  if (degrees_0_90 < 48 || degrees_0_90 > 87) {
    filledTriangle([floor_a, floor_b, roof_b], `rgb( 128,128,128)`, "");
  }
