...
function draw_yellow(degree_90) {
  ...
  if (degree_90 < 55) {
    ...
    ball(x1, y1, `rgb(255,0,0,255)`);
    planet(degree_90, 80, 110, `rgb(128,128,0,255)`);
  } else if (degree_90 < 59) {
    //
  } else if (degree_90 < 63) {
    ball(x1, y1, `rgb(0,0,0,255)`);
    planet(degree_90, 90, 120, `rgb(128,128,0,255)`);
  } else if (degree_90 < 70) {
    ball(x1, y1, `rgb(44,111,255,255)`);
  } else if (degree_90 < 73) {
    ball(x1, y1, `rgb(255,255,255,255)`);
    planet(degree_90, 190, 230, `rgb(128,128,0,255)`);
  } else if (degree_90 < 75) {
    //
  } else if (degree_90 < 78) {
    ball(x1, y1, `rgb(12,99,255,255)`);
    planet(degree_90, 210, 240, `rgb(255,233,199,255)`);

  } else {
    ball(x1, y1, `rgb(255,123,64,255)`);
    ctx.font = "48px serif";
    ctx.strokeStyle = black_color;
    ctx.strokeText(degree_90, degree_90 * 256 + 2, 64);
    // ball(x1, y1, `rgb(128,128,0,255)`);
