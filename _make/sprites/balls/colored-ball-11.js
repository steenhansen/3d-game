...
function drawBullet_left(degree_90) {
  ...
  for (i = 0; i < 360; i = i + 1) {
    x1 = Math.round(center_x + radius * Math.cos(2 * Math.PI * i / 360)) + frame_step;
    ...
    x2 = Math.round(center_x + inside_radius * Math.cos(2 * Math.PI * i / 360)) + frame_step;
  ...
  frame_step = degree_90 * 256;
  for (i = 0; i < 360; i = i + 1) {
    x1 = Math.round(center_x + radius * Math.cos(2 * Math.PI * i / 360) * flatten) + frame_step;
    y1 = Math.round(center_y + radius * Math.sin(2 * Math.PI * i / 360));

    // bot_half = Math.round(center_y + radius * Math.sin(2 * Math.PI * i / 360) * flatten);

    x2 = Math.round(center_x + inside_radius * Math.cos(2 * Math.PI * i / 360) * flatten) + frame_step;
