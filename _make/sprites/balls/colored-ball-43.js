...
function draw_red(degree_90) {
  ...
  if (degree_90 < 36) {
    ...
    ball(x1, y1, `rgb(255,10,10,255)`);
    planet(degree_90, 120, 145, `rgb(128,0,0,255)`);
  } else if (degree_90 < 40) {
    //
  } else if (degree_90 < 44) {
    ball(x1, y1, `rgb(255,120,0,255)`);
    planet(degree_90, 130, 170, `rgb(128,0,0,255)`);
  } else if (degree_90 < 51) {
    ball(x1, y1, `rgb(0,120,0,255)`);
  } else if (degree_90 < 54) {
    ball(x1, y1, `rgb(0,0,120,255)`);
    planet(degree_90, 230, 270, `rgb(128,0,0,255)`);
  } else if (degree_90 < 55) {
    //
  } else if (degree_90 < 59) {
    ball(x1, y1, `rgb(222,111,120,255)`);
    planet(degree_90, 255, 280, `rgb(128,0,128,255)`);
  } else {
    ball(x1, y1, `rgb(255,128,128,255)`);
