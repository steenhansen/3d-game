...
function drawBullet_left(degree_90) {
  ...
  // radius = 60;
  flatten_1 = 1;  //degree_90 / 100;
  flatten_2 = 1;  //degree_90 / 100;
  for (i = 0; i < 360; i = i + 1) {
    cos_x = Math.cos(2 * Math.PI * (i - 45) / 360);
    //    sin_y = Math.sin(2 * Math.PI * i / 360);
    sin_y = Math.sin(2 * Math.PI * (i + 90) / 360);
    x1 = Math.round(center_x + radius * cos_x * flatten_1) + frame_step;
    y1 = Math.round(center_y + radius * sin_y * flatten_2);


    x2 = Math.round(center_x + inside_radius * cos_x * flatten_1) + frame_step;
    y2 = Math.round(center_y + inside_radius * sin_y * flatten_2);
