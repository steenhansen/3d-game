...
function draw_green(degree_90) {
  ...
  planet(degree_90, 195, 340, `rgb(0,128,0,255)`);  // +155
...
function draw_blue(degree_90) {
  ...
  planet(degree_90, 115, 245, `rgb(0,0,128,255)`); // was 270 +155
...
function draw_red(degree_90) {
  ...
  planet(degree_90, 125, 280, `rgb(128,0,0,255)`);  // +155
...
function draw_yellow(degree_90) {
  ...
  if (degree_90 < 36) {
    ...
    if (degree_90 > 31) {
      planet(degree_90, 80, 105, `rgb(128,128,0,255)`);
    }
  ...
  //ball(x1, y1, `rgb(255,255,0,255)`);
  //planet(degree_90, 80, 240, `rgb(128,128,0,255)`);  // +155
