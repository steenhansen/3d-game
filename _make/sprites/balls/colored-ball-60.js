...
function draw_green(degree_90) {
  ...
  //   ball(x1, y1, `rgb(0,255,0,255)`);
  //   if (degree_90 > 55) {
  //     planet(degree_90, 200, 230, `rgb(128,128,128,255)`);
  //   }
  // } else if (degree_90 > 74) {
  //   ball(x1, y1, `rgb(0,255,0,255)`);
  //   if (degree_90 < 80) {
  //     planet(degree_90, 310, 340, `rgb(128,128,128,255)`);
  //   }
  // } else {
  //   ctx.font = "48px serif";
  ...
  //     ball(x1, y1, `rgb(0,255,0,255)`);
  //     planet(degree_90, 220, 320, `rgb(128,128,128,255)`);
  //   }
...
function draw_blue(degree_90) {
  ...
  } else if (degree_90 < 38) {
    ball(x1, y1, `rgb(0,0,255,255)`);
    planet(degree_90, 110 + 180, 140 + 180, `rgb(128,128,128,255)`);
  } else if (degree_90 < 41) {
    //
  } else if (degree_90 < 51) {
    ball(x1, y1, `rgb(0,0,255,255)`);
    planet(degree_90, 320, 405, `rgb(128,128,128,255)`);
  } else if (degree_90 < 53) {
    //
  } else if (degree_90 < 57) {
    ball(x1, y1, `rgb(0,0,255,255)`);
    //      planet(degree_90, 220, 250, `rgb(0,0,128,255)`);
    planet(degree_90, 400, 430, `rgb(128,128,128,255)`);

    // } else if (degree_90 > 58) {
    //   ball(x1, y1, `rgb(0,255,255,255)`);
...
function draw_red(degree_90) {
  ...
  } else if (degree_90 < 39) {
    ball(x1, y1, `rgb(255,0,0,255)`);
    planet(degree_90, 120, 145, `rgb(128,128,128,255)`);
  } else if (degree_90 < 40) {
    //
  } else if (degree_90 < 44) {
    ball(x1, y1, `rgb(255,0,0,255)`);
    planet(degree_90, 130, 170, `rgb(128,128,128,255)`);
  } else if (degree_90 < 51) {
    ball(x1, y1, `rgb(255,0,0,255)`);
  } else if (degree_90 < 54) {
    ball(x1, y1, `rgb(255,0,0,255)`);
    planet(degree_90, 230, 270, `rgb(128,128,128,255)`);
  } else if (degree_90 < 55) {
    //
  } else if (degree_90 < 59) {
    ball(x1, y1, `rgb(255,0,0,255)`);
    planet(degree_90, 255, 280, `rgb(128,128,128,255)`);
  } else {
    ball(x1, y1, `rgb(255,0,0,255)`);
...
function draw_yellow(degree_90) {
  ...
  if (degree_90 < 55) {
    ...
    ball(x1, y1, `rgb(255,255,0,255)`);
    planet(degree_90, 80, 110, `rgb(128,128,128,255)`);
  } else if (degree_90 < 59) {
    //
  } else if (degree_90 < 63) {
    ball(x1, y1, `rgb(255,255,0,255)`);
    planet(degree_90, 90, 120, `rgb(128,128,128,255)`);
  } else if (degree_90 < 70) {
    ball(x1, y1, `rgb(255,255,0,255)`);
  } else if (degree_90 < 73) {
    ball(x1, y1, `rgb(255,255,0,255)`);
    planet(degree_90, 190, 230, `rgb(128,128,128,255)`);
  } else if (degree_90 < 75) {
    //
  } else if (degree_90 < 78) {
    ball(x1, y1, `rgb(255,255,0,255)`);
    planet(degree_90, 210, 240, `rgb(128,128,128,255)`);
  } else {
    ball(x1, y1, `rgb(255,255,0,255)`);
    ctx.font = "48px serif";
    ctx.strokeStyle = black_color;
...
function makeBullets() {
  if (DO_DEBUG) {
    ...
    for (var the_degrees = 56; the_degrees <= 79; the_degrees = the_degrees + 1) {
      draw_green(the_degrees);  // back 56 79
    }
    ...
    // for (var the_degrees = 0; the_degrees <= 55; the_degrees = the_degrees + 1) {
    //   draw_green(the_degrees);  // back 56 79
    // }
