// cd documents/GitHub/squares/make/sprites/colored-balls/

// node colored-ball.js
...
function drawBullet_left(degree_90) {
  ...
  flatten = 1;  //degree_90 / 100;
  up_down = 0 - 10 + degree_90 * 1.45 + 100;
  ctx.lineWidth = 1;
  center_y = 64;  //(degree_90 + 10) * 3.15;
