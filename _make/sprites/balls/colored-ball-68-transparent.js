...
// node colored-ball-68-transparent.js
...
white_color = `rgb(255,255,255,64)`;
black_color = `rgb(0,0,0,64)`;
grey_color = `rgb(127,127,127,64)`;
red_color = `rgb(255,0,0,64)`;
green_color = `rgb(0,255,0,64)`;

yellow_top = `rgb(255, 255, 0,64)`;
yellow_middle = `rgb(255, 234, 0,64)`;
...
function planet2(degree_90) {
  deg_first_start = degree_90 * 4 / 3;
  deg_first_end = deg_first_start + 60;

  deg_second_start = degree_90 * 4 / 3 + 120;
  deg_second_end = deg_second_start + 60;
  deg_third_start = degree_90 * 4 / 3 + 240;
...
function makeBullets() {
  if (DO_DEBUG) {
    ...
    for (var the_degrees = 0; the_degrees <= 89; the_degrees = the_degrees + 1) {
      draw_green(the_degrees, `rgb(0,192,0,16)`);
      draw_blue(the_degrees, `rgb(0,0,192,16)`);
      draw_red(the_degrees, `rgb(192,0,0,16)`);
      draw_yellow(the_degrees, `rgb(224,224,0,16)`);
      planet2(the_degrees);
    }

    for (var the_degrees = 0; the_degrees <= 51; the_degrees = the_degrees + 1) {
      draw_yellow(the_degrees, `rgb(255,255,0,16)`);
    }
    ...
    for (var the_degrees = 0; the_degrees <= 52; the_degrees = the_degrees + 1) {
      draw_green(the_degrees, `rgb(0,255,0,16)`);
    }
