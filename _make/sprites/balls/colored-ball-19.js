...
function draw_w_e(degree_90) {
  ...
  frame_step = degree_90 * 256;
  // for (i = 0; i < 360; i = i + 1) {
  cos_x = Math.cos(2 * Math.PI * degree_90 / 360);
  sin_y = Math.sin(2 * Math.PI * degree_90 / 360);
  x1 = Math.round(center_x + radius * cos_x) + frame_step;
  ...
  // flatten_sw_ne = 0.77;
  // for (i = 0; i < 360; i = i + 1) {
  //   cos_x = Math.cos(2 * Math.PI * (i + 45) / 360);
  //   sin_y = Math.sin(2 * Math.PI * i / 360);
  //   x1 = Math.round(center_x + radius * cos_x * flatten_sw_ne) + frame_step;
  //   y1 = Math.round(center_y + radius * sin_y * flatten_sw_ne);


  //   x2 = Math.round(center_x + inside_radius * cos_x * flatten_sw_ne) + frame_step;
  //   y2 = Math.round(center_y + inside_radius * sin_y * flatten_sw_ne);

  //   ctx.strokeStyle = `rgb(${the_color},0,0,255)`;;
  //   ctx.beginPath();
  //   ctx.moveTo(x1, y1);
  //   ctx.lineTo(x2, y2);
  //   ctx.stroke();
  ...
  //   ctx.strokeStyle = `rgb(${the_color},0,${the_color},255)`;;
  //   ctx.beginPath();
  //   ctx.moveTo(x1, y1);
  //   ctx.lineTo(x2, y2);
  //   ctx.stroke();
