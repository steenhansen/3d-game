...
grey_color = `rgb(63,63,63,255)`;
red_color = `rgb(255,0,0,255)`;
green_color = `rgb(0,255,0,255)`;

//yellow_top = `rgb(255, 255, 0,255)`;  // 255-45 ==210
//yellow_middle = `rgb(255, 234, 0,255)`;

yellow_top = `rgb(210, 210, 0,255)`;  // 255-45 ==210 --> 255 + degree
yellow_middle = `rgb(145, 145, 0,255)`;
...
function drawBullet_left(degree_90) {
  ...
  for (i = 0; i < 180; i = i + 0.2) {
    ...
    //    yellow_off = 210 + degree_90;
    yellow_off = 145 + degree_90 * 2;
    ctx.strokeStyle = `rgb(${yellow_off}, ${yellow_off}, 0,255)`;
    ctx.beginPath();
    if (degree_90 == 44) {
    ...
    bottom_center_y = 210;   // qwe 200 - 210
    flatten_2 = 45 / 100;
...
function makeBullets() {
  if (DO_DEBUG) {
    ...
    // drawBand_left(28);
    // drawBand_left(29);
    for (var the_degrees = 0; the_degrees < 30; the_degrees = the_degrees + 1) {
