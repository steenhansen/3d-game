...
// for (var i = 0; i < y_centers.length; i++) {
//   y_centers[i] = new Array();
// }
...
function drawBullet_left(degree_90) {
  ...
  for (i = 0; i < 180; i = i + 0.2) {
    // console.log("xx", degree_90, center_y);
    // if (degree_90 == 44) {
    //   console.log("degree_90", degree_90);
    //   console.log("Math.round(i * 10)", Math.round(i * 5));
    //   console.log("center_y", center_y);
    // }
    // y_centers[degree_90][Math.round(i * 5)] = center_y;
...
function drawBullet_right(degree_90) { // 0..90     1/0 ,, 4/10
  ...
  //y_backwards = 44;
  // console.log(43, y_centers[43]);
  // console.log(44, y_centers[44]);
  // console.log(45, y_centers[45]);

  center_y = y_centers[89 - degree_90];
  flatten = y_flattens[89 - degree_90];
  up_down = up_downs[89 - degree_90];
  //y_backwards--;
  console.log("xxxxxxeqwew", degree_90, center_y);
