...
function initHoleData(hole_num, xy_pixels, hole_color, hole_hidden, vert_color) {
...
function makeHoles(hole_index, hole_color, holes_list, vert_color) {
    ...
    for (let h_index = 0; h_index < num_holes; h_index++) {
        ...
        const new_hole = initHoleData(hole_id, xy_pixels, hole_color, hole_hidden, vert_color);
