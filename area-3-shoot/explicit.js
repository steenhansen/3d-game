...
function action_runGame() {
  ...
  const slow_0_back_front_enemy = plainEnemy(
    [18, 3],
    ORANGE_GREY_FOG,
    ZERO_10,
    AWAY_10,
  ...
  const slow_1_back_front_enemy = plainEnemy(
    [18, 3],
    GREY_ORANGE_FOG,
    ZERO_10,
    NEAR_10,
  ...
  const fast_0_left_right_enemy = plainEnemy(
    [28, 2],
    WHITE_BLACK,
    RGHT_10,
    ZERO_10,
  ...
  const fast_1_left_right_enemy = plainEnemy(
    [28, 2],
    BLACK_WHITE,
    LEFT_10,
    ZERO_10,
  ...
  const pylon_points = [
    ...fast_left_right_2_pylon_points,
    ...corners_4_pylon_points,
    ...slow_back_front_2_pylon_points,
  ];
  const pylon_colors = [
    ...fast_left_right_2_pylon_colors,
    ...corners_4_pylon_colors,
    ...slow_back_front_2_pylon_colors,
  ];
  ...
  const corner_2_enemy = plainEnemy(
    [7, 3],
    LIME_FUCHSIA,
    LEFT_100,
    AWAY_100,
  ...
  const corner_3_enemy = plainEnemy(
    [7, 3],
    FUCHSIA_LIME,
    RGHT_100,
    NEAR_100,
