...
function action_runGame() {
    ...
    const ditch_holes = [
        [0, DITCH_LINE], [1.0625, forward_one], [2.125, DITCH_LINE], [3.1875, back_one],
        [4.25, DITCH_LINE], [5.3125, forward_one], [6.375, DITCH_LINE], [7.4375, back_one],
        [8.5, DITCH_LINE], [9.5625, forward_one], [10.625, DITCH_LINE], [11.6875, back_one],
        [12.75, DITCH_LINE], [13.8125, forward_one], [14.875, DITCH_LINE], [15.9375, back_one],

        [17, DITCH_LINE], [18.0625, forward_one], [19.125, DITCH_LINE], [20.1875, back_one],
        [21.25, DITCH_LINE], [22.3125, forward_one], [23.375, DITCH_LINE], [24.4375, back_one],
        [25.5, DITCH_LINE], [26.5625, forward_one], [27.625, DITCH_LINE], [28.6875, back_one],
        [29.75, DITCH_LINE], [30.8125, forward_one], [31.875, DITCH_LINE], [32.9375, back_one]];

    const red_holes = makeHoles(0, "red", ditch_holes);

    const back_holes = [
        [0, 17], [2, 17], [4, 17], [6, 17], [8, 17],
        [10, 17], [12, 17], [14, 17], [16, 17],
        [18, 17], [20, 17], [22, 17], [24, 17],
        [26, 17], [28, 17], [30, 17], [32, 17]];
