...
const RED_BLUE = ["red", "blue"];
const BLUE_RED = ["blue", "red"];

const LIME_FUCHSIA = ["Lime", "Fuchsia"];
const FUCHSIA_LIME = ["Fuchsia", "Lime"];
...
const ORANGE_GREY_FOG = ["#ffaa00dd", "#999999dd"];
const GREY_ORANGE_FOG = ["#999999dd", "#ffaa00dd"];

const ORANGE_GREY = ["#ffaa00", "#999999"];
const GREY_ORANGE = ["#999999", "#ffaa00"];

const RED_BLUE_1 = ["#ff0000", "#0000ff"];
const RED_BLUE_2 = ["#dd0000", "#0000dd"];
const RED_BLUE_3 = ["#bb0000", "#0000bb"];
const RED_BLUE_4 = ["#990000", "#000099"];

const ORANGE_GREY_1 = ["#ffaa00", "#ffffff"];
const ORANGE_GREY_2 = ["#dd8800", "#dddddd"];
...
const YELLOW_CYAN_3 = ["#bbbb00", "#00bbbb"];
const YELLOW_CYAN_4 = ["#999900", "#009999"];