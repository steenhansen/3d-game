...
function enemySet(the_sprite, html_id) {
  ...
  document.documentElement.style.setProperty("--my-planet-x", x_px);
  document.documentElement.style.setProperty("--my-planet-y", y_px);
  document.documentElement.style.setProperty("--my-planet-width", w_px);
  document.documentElement.style.setProperty("--my-planet-height", h_px);
...
function enemyDraw(an_enemy, the_player) {
  ...
  document.documentElement.style.setProperty("--my-planet-z", the_z_index);
