...
function staticStar(star_color, enemy_number) {
  ...
  const star_points = "m 508.91671,254.44059 59.41448,170.89707 180.81736,3.64637 L 605.00944,538.26808 657.39929,711.41732 508.91671,608.08545 360.43414,711.41732 412.82398,538.26808 268.68487,428.98403 449.50223,425.33766 Z";
  const static_star = `
...
function rotatingStar(star_color, enemy_number, rotate_sec) {
  ...
  function leftRightStaticStar(type_id, from_rotate, to_rotate) {
    const rotating_star_points = "m 508.91671,254.44059 59.41448,170.89707 180.81736,3.64637 L 605.00944,538.26808 657.39929,711.41732 508.91671,608.08545 360.43414,711.41732 412.82398,538.26808 268.68487,428.98403 449.50223,425.33766 Z";
    const star_to_from = `
      <circle cx="512" cy="512" id="sun:circle" r="256" stroke="${star_color}" stroke-width="0" fill-opacity="0" />
      <g id="${type_id}">
  ...
  const star_fixed = leftRightStaticStar(`star-spin-fixed-${enemy_number}`, "0 512 512", "0 512 512");
  const star_clockwise = leftRightStaticStar(`star-spin-clockwise-${enemy_number}`, "0 512 512", "360 512 512");
  const star_counter = leftRightStaticStar(`star-spin-counter-${enemy_number}`, "360 512 512", "0 512 512");
