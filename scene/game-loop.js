function runGame(
  ...
  function gameLoop() {
    ...
    if (game_state == GAME_0_INIT) {
      [game_state, part_state, g_planet, g_player] = initPart0(
        game_state,
        part_state,
        g_planet,
        g_player,
      ...
      [game_state, part_state, g_signs] = introPart1(
        game_state,
        part_state,
        g_signs,
      );
    } else if (game_state == GAME_2_PLAY) {
      const variable_list = playPart2(
        game_state,
        part_state,
        g_planet,
        g_player,
      ...
      [game_state, part_state, g_planet, g_player, g_enemies, g_pylons] =
        variable_list;
      ...
      [part_state, g_player] = spacePart4(
        part_state,
        g_planet,
        g_player,
        g_enemies,
