...
function playPart2(game_state, part_state, the_planet, the_player, enemy_list, pylon_list, sign_list) {
  ...
  if (all_dead) {
    [game_state, part_state, the_player] = playerHitSigns(game_state, part_state, the_player, sign_list);
  }
  const the_return = [game_state, part_state, the_planet, the_player, enemy_list, pylon_list];
  return the_return;
}
...
function generalPlay(part_state, the_planet, the_player, enemy_list, pylon_list, sign_list) {
  [the_planet, the_player, enemy_list, pylon_list] = animateScene(the_planet, the_player, enemy_list, pylon_list, sign_list, g_holes);
